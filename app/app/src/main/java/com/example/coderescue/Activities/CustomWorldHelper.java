...
//                    }
    ...
    public static Task getDisasters(){
...
//                                textView.append(i.getString("longitude"));
                                ...
                                Document coordinates = (Document) i.get("coordinates");
//                                List<Document> temp = (List<Document>)first.get("victims");

                                double latdis = Double.parseDouble((String) coordinates.get("latitude"));
                                double longidis = Double.parseDouble((String) coordinates.get("longitude"));
...
//                                listVictims.add(go2);
                                ...
                                Log.d("Correct", "latlong -> " + latdis +" " + longidis);

                            }
                        }
                        Log.d("Correct", "Hello Jii" + Integer.toString(listDisasters.size()));
