...
public class SafeHouseHolder extends RecyclerView.ViewHolder implements View.OnClickListener{

    TextView mTitle, mLat, mLong, name;
    private ItemClickListener itemClickListener;

    public SafeHouseHolder(@NonNull View itemView){
        super(itemView);
